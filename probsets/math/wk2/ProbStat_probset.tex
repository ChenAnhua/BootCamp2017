...
\begin{flushleft}
   \textbf{\large{Math, Problem Set \#2, Probability Theory}} \\[5pt]
...
\begin{enumerate}
	...
	Define $<x,y>$ as $x \times y$ in a real inner porduct space. It's easy to show that $<x, y>$ satisfies all there properties of an IPS. \\
		\item[(i)] RHS $= \frac{1}{4} ((x + y)\times (x + y) - (x-y)\times (x-y)) = x \times y = $LHS\\
		\item[(ii)] RHS $= \frac{1}{2} (2x^2 + 2y^2) = x^2 + y^2 = $ LHS\\
